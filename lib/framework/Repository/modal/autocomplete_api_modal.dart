...
//
//     final autoCompleteApiModal = autoCompleteApiModalFromJson(jsonString);

import 'dart:convert';

AutoCompleteApiModal autoCompleteApiModalFromJson(String str) => AutoCompleteApiModal.fromJson(json.decode(str));

String autoCompleteApiModalToJson(AutoCompleteApiModal data) => json.encode(data.toJson());

class AutoCompleteApiModal {
  AutoCompleteApiModal({
    this.predictions,
    this.status,
  });
  ...
  factory AutoCompleteApiModal.fromJson(Map<String, dynamic> json) => AutoCompleteApiModal(
